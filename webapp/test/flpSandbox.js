		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ER - Turnos",
									"targetURL": "#comsofttekaca20241qer-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsofttekaca20241qer-display": {
								"semanticObject": "comsofttekaca20241qer",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.softtek.aca20241qer",
									"url": sap.ui.require.toUrl("com/softtek/aca20241qer")
								}
							}
						}
					}
